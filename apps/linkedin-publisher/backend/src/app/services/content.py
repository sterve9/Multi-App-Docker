...
{{
  ...
  "image_prompt": "Detailed scene description for AI image generation: professional man in [specific inspiring context related to the topic], cinematic lighting, photorealistic, ultra high quality, [specific visual details about the environment], powerful and aspirational atmosphere, 9:16 vertical format. The man is the main subject, confident and visionary expression.",
